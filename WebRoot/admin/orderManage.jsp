...
<script type="text/javascript">
	...
	var authOrderStatusArray;
$.getJSON("${pageContext.request.contextPath}/servlet/DictionarysParamServlet?nickName=authOrde", function(data){
	authOrderStatusArray=data;
});

function authOrderStatusArrayFormatter(value){
	for(var i=0; i<authOrderStatusArray.length; i++){		
		if (authOrderStatusArray[i].value == value) 
		return authOrderStatusArray[i].name;
	}
	return value;
}
...
<table id="dg" title="订单管理" class="easyui-datagrid" fitColumns="true" 
    ...
    <thead>
    	<tr>
    		...
    		<th field="userName" width="50" align="center" >订单人用户名</th>
    		<th field="theAppointment" width="80" align="center"  >下单时间</th>
    		<th field="total" width="50" align="center" >总金额(元)</th>
    	    <th field="state" width="100" align="center"  formatter="formatStatus" >订单状态</th> 
    	 	<th field="remarks">留言</th>
    		...
    		<th field="username">收货人姓名</th>
    	</tr>
    </thead>
</table>
<div id="tb">
	<div>
		<a href="javascript:openOrderDetailDialog()" class="easyui-linkbutton" iconCls="icon-search" plain="true">查看订单详情</a>
		<!-- <a href="javascript:modifyOrderStatus(2)" class="easyui-linkbutton" iconCls="icon-shenhe" plain="true">审核通过</a> -->
		<a href="javascript:modifyOrderStatus(3)" class="easyui-linkbutton" iconCls="icon-ok" plain="true">已发货</a>
	</div>
	<div>
 用户名：<input class="easyui-combobox" name="language" data-options="
			url:'${pageContext.request.contextPath}/servlet/AppParamServlet?nickName=user',
				valueField: 'value',
				textField: 'name',
				panelWidth: 350,
				panelHeight: 'auto'
		...
		&nbsp;订单号：&nbsp;<input type="text" name="orderNo"  id="orderNo"  size="20" />
		&nbsp;订单人：&nbsp;<input type="text" name="userName"  id="userName"  size="20" />
	   订单状态：<input class="easyui-combobox" name="language" data-options="
				url: '${pageContext.request.contextPath}/servlet/DictionarysParamServlet?nickName=authOrde',
				valueField: 'value',
				textField: 'name',
				panelWidth: 350,
				panelHeight: 'auto'
...
<div id="dlg" class="easyui-dialog" style="width: 750px;height: 400px;padding: 10px 30px"
  closed="true" buttons="#dlg-buttons">
  	<table cellspacing="8px;">
  		<tr>
  			<td>订单号：</td>
  			<td><input type="text" id="orderNo1"  readonly="readonly" /></td>
  			<td>&nbsp;</td>
  			<td>买家姓名：</td>
